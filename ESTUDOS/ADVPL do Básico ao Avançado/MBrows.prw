...
//BOTOES MENU
	...
	//AADD(aRotina,{"Legenda" ,"U_Legenda" ,0,3}) Exclui o botใo de legenda do usuแrio
	If Retcodusr() # "000000" // Condi็ใo para ter acesso ao botใo da fun็ใo de regua PbMsgRUN
